...
- Run `bundle exec jekyll serve` also works after a cleanup, whenever there are major changes.
- Contents of the `weeks` page are generated by the `life-in-weeks` project.
